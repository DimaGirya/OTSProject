...
public class ReportTaskActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private RadioButton radioButtonWaiting,radioButtonAccept,radioButtonReject;
    private RadioButton radioButtonWaitingInProgress,radioButtonInProgress,radioButtonDone;
    private RadioGroup radioGroupStatus,radioGroupProgress;
    private TextView taskCategoryTextView, taskDescriptionTextView, taskHeaderTextView ,taskPriorityTextView;
    private TextView textViewProgress,textViewStatus,textViewDeadline;
    private TextView texViewEmployeeTask,employeeOfTask,textViewLocationTask;
    private  Button picture;
    private Button reportTask;
    private ParseUser currentUser;
    private DataAccess dataAccess;
    private Task taskToReport;
    private String taskIdToReport;
